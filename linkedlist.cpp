...
cout<< "*****aaaaaaaaaaaaaaaaaaaaaaaaaaaaa>"<< size << endl;
...
Object* LinkedList::last()const {
	cout<< "entro a last"<< endl;
    if (!head){
		cout<< "entre a not head-----------------------------"<< endl;
        return NULL;
		cout<< "entre a not head"<< endl;
	}
	cout<< "no entro a head"<< endl;
    DLLNode* tmp = head;
	cout<< "DLLNode* tmp = head:: "<<tmp->getData() << endl;
	cout<< "-->"<< size<< "<--"<< endl;
//	tmp = tmp->getNext();
//	tmp = tmp->getNext();
//	tmp = tmp->getNext();
...
//	return tmp->getData();
    ...
    for (int i=1; i < size; i++){
		//cout<< "entre a for::: "<< i<< endl;
        tmp = tmp->getNext();
		//cout<< "hise la instruccion"<< endl;
	}
	cout<< "sali de for"<< endl;
	cout<< "return tmp->getData():: "<<tmp->getData() << endl;
    return tmp->getData();
}
